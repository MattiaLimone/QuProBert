# -*- coding: utf-8 -*-
"""Amazon_KDD_bert_mlp_adamw_optimizer_8_epochs.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/100QYzePoy_uxCXAc42ULDPu-u1hTKmxL
...
train_df = pd.read_csv('import/train/train_final.csv')
...
#model = MonoBERT.from_pretrained('bert-base-multilingual-uncased')
...
esci_model.save('models/esci_model_mlp_adamw_no_optimizer_8_epochs', include_optimizer=False)

esci_model.save('models/esci_model_mlp_adamw_with_optimizer_8_epochs', include_optimizer=True)
