# -*- coding: utf-8 -*-
"""Amazon_KDD_bert_mlp_adamw_optimizer_8_epochs_200k.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1w3hUOyD317uEJpzdNsYevgpkygajx1xX
...
train_df = pd.read_csv('import/train/train_final_200k.csv')
...
train_df = train_df.drop(train_df.columns[[1,2,4,5,6]], axis=1)
train_df.head()
...
weight_for_2 = (1 / train_df['esci_label'].value_counts()['complement'])*(NUM_ELEMENTS/4.0)/2
...
X_input_ids = np.zeros((len(train_df), 100))

"""## Initialize Attention Mask variable
This argument indicates to the model which tokens should be attended to, and which should not.
"""

X_attn_masks = np.zeros((len(train_df), 100))
X_token_ids = np.zeros((len(train_df), 100))
...
token_ids = tf.keras.layers.Input(shape=(100,), name='token_type_ids', dtype='int32')
...
#intermediate layer
hidden_layer_1 = tf.keras.layers.Dense(100,activation='relu', name='hidden_layer_1')(bert_embds)
